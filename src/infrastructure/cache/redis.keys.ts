...
export const RedisKeys = {
  ...
  towers: {
    ...
    userActive: (username: string) =>
      `towers:user:${username.toLowerCase()}:active`,
  ...
  cache: {
    userProfile: (username: string | number) =>
      `cache:user:profile:${username}`,
    publicUserProfile: (username: string | number) =>
      `cache:user:publicProfile:${username}`,
    inventory: (username: string | number) =>
      `cache:user:inventory:${username}`,
     ...
     */
    affiliate: {
      epoch: (username: string) => `cache:affiliate:epoch:${username.trim()}`,
  ...
  giveaway: {
    ...
    userJoined: (username: string) => `user:${username}:joined_giveaways`,
  },
  ...
  leveling: {
    ...
    leaderboard: (limit: number, offset: number) =>
      `leveling:leaderboard:${limit}:${offset}`,
  ...
  rewardCases: {
     ...
     */
    openLock: (username: string) => `cache:reward-cases:open-lock:${username}`,
  },
  ...
  race: {
    ...
    minesQuickStreak: (username: string) => `race:wager:minesQuick:${username}`,
  },
} as const;
